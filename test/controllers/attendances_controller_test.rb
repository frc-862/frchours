...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { signin: @attendance.signin, signout: @attendance.signout, student_id: @attendance.student_id }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { signin: @attendance.signin, signout: @attendance.signout, student_id: @attendance.student_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
